 ...
 * @LastEditTime: 2022-03-10 14:16:28
...
/*  A. Oops, It’s Yesterday Twice More
    先左/右n-1再上/下n-1集中在一起，然后沿着曼哈顿到(a,b)
*/
void init(){}
void PX()
{
    int n,a,b;cin>>n>>a>>b;
    char x,y,xx,yy;
    if(a<=n/2)x='U',xx='D';else x='D',xx='U',a=n-a+1;
    if(b<=n/2)y='L',yy='R';else y='R',yy='L',b=n-b+1;
    for(int i=1;i<n;i++)cout<<x;
    for(int i=1;i<n;i++)cout<<y;
    for(int i=1;i<a;i++)cout<<xx;
    for(int i=1;i<b;i++)cout<<yy;
    cout<<'\n';
}
int main()
{
