 ...
 * @Date: 2022-04-22 19:11:46
 * @LastEditors: violet apricity ( Zhuangpx )
 * @LastEditTime: 2022-04-22 19:11:46
 * @FilePath: \apricitye:\桌面\ACM\算法Algorithm\图论\平面点的曼哈顿最小生成树\求最第k大边.cpp
...
/*	C - 曼哈顿最小生成树	https://vjudge.net/contest/490329#problem/C
	二维平面点的曼哈顿最小生成树 Manhattan MST	求最大边即可
...
void PX()
{
	...
	int ans=Manhattan_minimum_spanning_tree(n,p);
	cout<<ans<<'\n';
}
signed main()
{
