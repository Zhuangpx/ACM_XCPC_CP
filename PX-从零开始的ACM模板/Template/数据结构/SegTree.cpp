...
int op(int a, int b) {return min(a, b);}    //  min -> min{a,b}
int e() {return INT_MAX;}                   //  min -> MAX
int op2(int a, int b) {return a + b;}       //  sum -> a+b
int e2() {return 0;}                        //  sum -> 0

int main()
{
    int n = 10;
    lazy_segtree<int, op, e, int, op, op, e> seg_min(n);
    lazy_segtree<int, op2, e2, int, op2, op2, e2> seg_sum(n);
}
